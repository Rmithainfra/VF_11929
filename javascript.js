...
function togglePopupWindows() {
    var popupContainers = [
        ...
        // document.getElementById('popup-container-8'),
        document.getElementById('popup-container-9'),
        document.getElementById('popup-container-10'),
    ];
...
//     viewer.loadScene('image-8');
//     togglePopupWindows();
// });
document.getElementById('image-9').addEventListener('click', function() {
    viewer.loadScene('image-9');
    togglePopupWindows();
});
document.getElementById('image-10').addEventListener('click', function() {
    viewer.loadScene('image-10');
    togglePopupWindows();
});
